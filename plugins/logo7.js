...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'pbreakwall ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'pbreakwall ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
